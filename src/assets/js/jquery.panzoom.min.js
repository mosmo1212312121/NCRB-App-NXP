...
!(function(a, b) {
  ...
  function g(a, c) {
    ...
    1 !== a.nodeType && b.error('Panzoom called on non-Element node'),
      b.contains(h, a) || b.error('Panzoom element must be attached to the document');
    var d = b.data(a, i);
    if (d) return d;
    ...
    (this.$set = c.$set && c.$set.length ? c.$set : e),
      ...
      (this.isSVG = n.test(a.namespaceURI) && 'svg' !== a.nodeName.toLowerCase()),
      (this.panning = !1),
  ...
  return (
    (e.prototype = {
      ...
      determinant: function() {
        var a = this.elements;
        return (
          a[0] * (a[8] * a[4] - a[7] * a[5]) - a[3] * (a[8] * a[1] - a[7] * a[2]) + a[6] * (a[5] * a[1] - a[4] * a[2])
        );
      }
    }),
    ...
    (g.prototype = {
      ...
      setTransform: function(a) {
        for (var c = this.$set, d = c.length; d--; )
          b.style(c[d], 'transform', a), this.isSVG && c[d].setAttribute('transform', a);
      },
        ...
        return (
          a
            ...
            : ((a = b.style(d, 'transform')),
              !this.isSVG || (a && 'none' !== a) || (a = b.attr(d, 'transform') || 'none')),
          'none' === a || q.test(a) || this.setTransform((a = b.css(d, 'transform'))),
          a || 'none'
        );
      },
      ...
      setMatrix: function(a, c) {
        if (!this.disabled) {
          ...
          var d = +a[0],
            e = 'undefined' != typeof c.contain ? c.contain : this.options.contain;
          if (e) {
            var f = c.dims;
            ...
            var g,
              ...
              o = m / k,
              p = n / l;
            'center' !== this.$parent.css('textAlign') || 'inline' !== b.css(this.elem, 'display')
              ? ((i = (k - this.elem.offsetWidth) / 2), (g = i - f.border.left), (h = k - m - i + f.border.right))
              : (g = h = (k - m) / 2);
      ...
      zoom: function(a, c) {
        ...
        if (!d.disableZoom) {
          ...
          'number' != typeof a &&
            ((a =
              d.exponential && i - d.increment >= 1 ? Math[a ? 'sqrt' : 'pow'](i, 2) : i + d.increment * (a ? -1 : 1)),
            (g = !0)),
            a > d.maxScale ? (a = d.maxScale) : a < d.minScale && (a = d.minScale);
          var j = d.focal;
          if (j && !d.disablePan) {
            this.resetDimensions();
            var k = (d.dims = this.dimensions),
              l = j.clientX,
              m = j.clientY;
            ...
            var n = new f(l, m, 1),
              ...
              q = new e(1, 0, p.left - this.$doc.scrollLeft(), 0, 1, p.top - this.$doc.scrollTop()),
              r = o.inverse().x(q.inverse().x(n)),
              s = a / h[0];
            (o = o.x(new e([s, 0, 0, s, 0, 0]))),
              (n = q.x(o.x(r))),
              (h[4] = +h[4] + (l - n.e(0))),
              (h[5] = +h[5] + (m - n.e(1)));
          }
          (h[0] = a),
            ...
            this.setMatrix(h, { animate: 'undefined' != typeof d.animate ? d.animate : g, range: !d.noSetRange }),
      ...
      _initStyle: function() {
        ...
        c.length &&
          ...
          ((a = { overflow: 'hidden' }), 'static' === c.css('position') && (a.position = 'relative'), c.css(a));
      },
        ...
        if (
          ...
          (c.disablePan && c.disableZoom) ||
            ((i[f] = function(b) {
              var d;
              ('touchstart' === b.type
                ? !(d = b.touches || b.originalEvent.touches) || ((1 !== d.length || c.disablePan) && 2 !== d.length)
                : c.disablePan || (b.which || b.originalEvent.which) !== c.which) ||
          ...
          var x = function(a) {
            ...
            if ((a.preventDefault(), (d = a.touches || a.originalEvent.touches), w(a, d), d)) {
              if (2 === d.length) {
                ...
                return (
                  n.zoom(e * (o.increment / 100) + i, { focal: c, matrix: q, animate: 'skip' }),
                  n.pan(+q[4] + c.clientX - j.clientX, +q[5] + c.clientY - j.clientY, u),
                  void (j = c)
                );
              }
      ...
      return 'string' == typeof a
        ? ((f = []),
          ...
          this.each(function() {
            (c = b.data(this, i)),
              c
                ? '_' !== a.charAt(0) && 'function' == typeof (e = c[a]) && void 0 !== (e = e.apply(c, d)) && f.push(e)
                : f.push(void 0);
          }),
