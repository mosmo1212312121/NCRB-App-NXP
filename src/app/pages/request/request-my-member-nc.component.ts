...
@Component({
  selector: 'app-request-my-member-nc',
  templateUrl: './request-my-member-nc.component.html'
})
export class RequestMyMemberComponent extends BaseComponent implements OnInit, OnDestroy {
  items: Score[] = [];
  ...
  constructor(
    ...
    // initial component
    super(logService);
    this.setPageName('requests/mylists/member');
  ...
  public get title(): string {
    const idx: number = this.parameter.findIndex(o => o.label === 'TITLE_MY_MEMBER_NC_LIST');
    if (idx > -1) {
