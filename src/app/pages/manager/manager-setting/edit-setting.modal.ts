...
export class EditSettingModalComponent extends BaseComponent implements OnInit {
  title: string = 'Edit Setting';
  form: FormGroup;
  data: Parameter = null;
  ...
  constructor(
    ...
    // initial component
    super(logService);
    this.setPageName('management/setting-edit-management (modal)');
