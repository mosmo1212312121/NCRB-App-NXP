...
@Component({
  selector: 'app-parameter-modal-add',
  template: `
...
export class AddParameterModalComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    // initial component
    super(logService);
    this.setPageName('management/parameter-add-management (modal)');
