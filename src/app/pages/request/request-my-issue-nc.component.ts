...
@Component({
  selector: 'app-request-my-issue-nc',
  templateUrl: './request-my-issue-nc.component.html'
})
export class RequestMyIssueComponent extends BaseComponent implements OnInit, OnDestroy {
  items: Score[] = [];
  ...
  constructor(
    ...
    // initial component
    super(logService);
    this.setPageName('requests/mylists/issue');
  ...
  public get title(): string {
    const idx: number = this.parameter.findIndex(o => o.label === 'TITLE_MY_ISSUE_NC_LIST');
    if (idx > -1) {
